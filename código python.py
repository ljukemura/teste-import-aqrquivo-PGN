...
diretorio = listdir('D:\Python\experimentos\Imagem Planilhas')
diretorio.remove("Resultados")
...
im = Image.open('D:\Python\experimentos\Imagem Planilhas\\' + diretorio[escolha_usuario])

pygame.init()

bg = pygame.image.load('D:\Python\experimentos\Imagem Planilhas\\' + diretorio[escolha_usuario])
...
with open('D:\Python\experimentos\Imagem Planilhas\Resultados\\' + saida2, 'w') as arq_saida:
